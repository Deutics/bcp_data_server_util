...
class DataFetcher:
    ...
    class Report:
        class Student:
            ...
            class AllStudentsBranchAggByClass(DataFetcherMain):
                _dates = []
                _endpoint = "/report/student/all_branch_agg_by_class"
        ...
        class Subject:
            class SubjectList(DataFetcherMain):
                _dates = []
                _endpoint = "/report/subject/subject_list"

            class SubjectListByBranchTeacher(DataFetcherMain):
                _dates = []
                _endpoint = "/report/subject/subject_list/by_branch_teacher"
